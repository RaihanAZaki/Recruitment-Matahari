<?
	...
	*/
	...
	if($server=="localhost"){
		$_database["sqlhost"] = "localhost:3360";						// local
		$_database["username"] = "root";
		$_database["password"] = "shakti";
		$_database["databasename"] = "mpprecruitment";
		define("_PATHURL","http://localhost:9937/mpprecruitment");
	}
	else{
		$_database["sqlhost"] = "localhost:3360";						// online
		$_database["username"] = "root";
		$_database["password"] = "shakti";
		$_database["databasename"] = "mpprecruitment";
		define("_PATHURL","http://192.168.200.62:9937/mpprecruitment");
	}
