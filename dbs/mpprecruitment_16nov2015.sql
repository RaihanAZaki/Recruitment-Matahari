...
--
-- Host: localhost
-- Generation Time: Nov 16, 2015 at 05:47 PM
...
(1, 1, 'shakti.santoso@hypermart.co.id', 'E/Pe9Q/bKhPyeTuIifQm8/KqNJzFmUW217G5qXxLcM6', 'admin', '2015-11-16 10:36:43', 'TimothyGabrielB / 127.0.0.1', 0, '2015-09-10 10:18:37', 'activationcode', NULL, 'active', 1, '2015-09-10 10:19:06', 1, '2015-11-04 16:01:22'),
...
(1, 'HRIS Specialist', 'Tangerang', '<p>Designing and building Human Resource Information System in collaboration with IT team and external vendor.\r\n</p><ul><li>\r\nCandidate must possess at least a Bachelor Degree, Master Degree / Post Graduate Degree, Computer Science/Information Technology, Human Resource Management or equivalent.\r\n</li><li>At least 3 year(s) of working experience in the related field is required for this position.\r\n</li><li>Applicants must be willing to work in BANTEN.\r\n</li><li>Preferably Manager / Assistant Managers specializing in Human Resources or equivalent.\r\n</li><li>Full-Time position(s) available.\r\n</li><li>Basic Programming\r\n</li><li>Understand HR System and procedure\r\n</li><li>Basic Database (SQL Server)\r\n</li><li>Support HRIS\r\n</li><li>Able to act as Project Manager\r\n</li><li>Have good communication skill\r\n</li><li>Willing to learn a new thing related to HR System</li></ul><p>Ini deskripsi panjang tulisannya jadi aneh bingiiittt, moga ga brantakan deh kalo gini caranyaa. huhuhuhuhu\r\n</p>', '<ul><li>Designing and building Human Resource Information System.</li><li><span style="line-height: 2;">In collaboration with IT team and external vendor.</span></li></ul>', 'Bachelor - S1', '', '', '', '', 'Permanent', '2015-09-15', '2015-11-30', 1, 0, 0, '', 3, 2, 'closed', 1, '2015-09-15 10:27:27', 1, '2015-11-13 09:00:44'),
(2, 'Staff Gudang', 'Jakarta', 'Staff gudang description is here Staff gudang description is here Staff gudang description is here Staff gudang description is here Staff gudang description is here Staff gudang description is here Staff gudang description is here Staff gudang description is here ', 'Staff gudang description is here ', 'Highschool - SMA', '', '', '', '', 'Contract', '2015-09-15', '2015-11-15', 3, 0, 0, '', 8, 9, 'closed', 1, '2015-09-15 10:31:22', 1, '2015-11-13 09:00:46'),
(4, 'Head Manager', 'Bandung', '<ul><li>Head Manager desc is needed to blah blah blah Head Manager desc is needed to blah blah blah Head Manager desc is needed to blah blah blah Head Manager desc is needed to blah blah blah Head </li><li>Manager desc is needed to blah blah blah Head Manager desc is needed to blah blah blah Head Manager desc is needed to </li><li>blah blah blah Head Manager desc is needed to blah blah blah Head Manager desc is needed to blah blah blah </li></ul>', 'Head Manager desc is needed.', 'Bachelor - S1', '', '', '', '', 'Permanent', '2015-09-15', '2015-11-15', 1, 0, 0, '', 8, 9, 'closed', 1, '2015-09-15 10:36:12', 9, '2015-11-13 09:00:47'),
(5, 'Warehouse Staff', 'Surabaya', 'Staff gudang is currently needed in order to keep blah blah blah Staff gudang is currently needed in order to keep blah blah blah Staff gudang is currently needed in order to keep blah blah blah Staff gudang is currently needed in order to keep blah blah blah Staff gudang is currently needed in order to keep blah blah blah Staff gudang is currently needed in order to keep blah blah blah Staff gudang is currently needed in order to keep blah blah blah ', 'Staff gudang is currently needed in order to keep blah blah blah ', 'Highschool - SMA', NULL, NULL, NULL, NULL, 'Daily Worker', '2015-09-15', '2015-11-15', 0, 0, 0, NULL, 8, 2, 'closed', 1, '2015-09-15 10:37:11', 1, '2015-11-13 09:00:48'),
(6, 'Retail Manager', 'Tangerang', 'Retail manager is responsible for all retail process in his/ her retail area. make it longer here and bla bla bla Retail manager is responsible for all retail process in his/ her retail area. make it longer here and bla bla bla Retail manager is responsible for all retail process in his/ her retail area. make it longer here and bla bla bla Retail manager is responsible for all retail process in his/ her retail area. make it longer here and bla bla bla Retail manager is responsible for all retail process in his/ her retail area. make it longer here and bla bla bla ', 'Retail manager is responsible for all retail process in his/ her retail area.', 'Bachelor - S1', NULL, NULL, NULL, NULL, 'Contract', '2015-10-19', '2015-10-19', 0, 0, 0, NULL, 8, 9, 'closed', 1, '2015-10-19 14:04:50', 1, '2015-11-13 09:00:50'),
...
(1, 1, 1, 'y', 'new house', '2015-10-05 09:29:10', 4, '2015-10-05 09:29:10', 4, '2015-11-16 10:22:29'),
(2, 1, 2, 'n', 'no land', '2015-10-05 09:29:10', 4, '2015-10-05 09:29:10', 4, '2015-11-16 10:22:29'),
(34, 1, 10, 'n', 'no contract lah', '2015-10-05 11:40:20', 4, '2015-10-05 11:40:20', 4, '2015-11-16 10:22:29'),
(4, 1, 4, 'y', 'supra', '2015-10-05 09:29:10', 4, '2015-10-05 09:29:10', 4, '2015-11-16 10:22:29'),
(5, 1, 5, 'y', 'rent house', '2015-10-05 09:29:10', 4, '2015-10-05 09:29:10', 4, '2015-11-16 10:22:29'),
(30, 1, 20, '', 'dc', '2015-10-05 11:38:13', 4, '2015-10-05 11:38:13', 4, '2015-11-16 10:22:29'),
(8, 1, 8, 'n', 'never applied', '2015-10-05 09:29:10', 4, '2015-10-05 09:29:10', 4, '2015-11-16 10:22:29'),
(9, 1, 9, 'n', 'no other comp', '2015-10-05 09:29:10', 4, '2015-10-05 09:29:10', 4, '2015-11-16 10:22:29'),
(11, 1, 11, 'n', 'dont have time', '2015-10-05 09:29:10', 4, '2015-10-05 09:29:10', 4, '2015-11-16 10:22:29'),
(12, 1, 12, 'y', 'sure lah', '2015-10-05 09:29:10', 4, '2015-10-05 09:29:10', 4, '2015-11-16 10:22:29'),
(13, 1, 13, 'n', 'no relatives', '2015-10-05 09:29:10', 4, '2015-10-05 09:29:10', 4, '2015-11-16 10:22:29'),
(26, 1, 21, '', '15000000', '2015-10-05 11:27:14', 4, '2015-10-05 11:27:14', 4, '2015-11-16 10:22:29'),
(15, 1, 15, 'y', 'job interview', '2015-10-05 09:29:10', 4, '2015-10-05 09:29:10', 4, '2015-11-16 10:22:29'),
(16, 1, 16, 'n', 'good civilian', '2015-10-05 09:29:10', 4, '2015-10-05 09:29:10', 4, '2015-11-16 10:22:29'),
(17, 1, 17, 'y', 'love travelling', '2015-10-05 09:29:10', 4, '2015-10-05 09:29:10', 4, '2015-11-16 10:22:29'),
(18, 1, 18, 'y', 'love indonesia', '2015-10-05 09:29:10', 4, '2015-10-05 09:29:10', 4, '2015-11-16 10:22:29'),
(31, 1, 23, '', 'today', '2015-10-05 11:38:13', 4, '2015-10-05 11:38:13', 4, '2015-11-16 10:22:29'),
(25, 1, 14, 'n', 'healthy as hell', '2015-10-05 11:27:14', 4, '2015-10-05 11:27:14', 4, '2015-11-16 10:22:29'),
(24, 1, 7, 'n', 'blon tetep', '2015-10-05 11:27:14', 4, '2015-10-05 11:27:14', 4, '2015-11-16 10:22:29'),
(33, 1, 6, 'n', 'no company house', '2015-10-05 11:40:20', 4, '2015-10-05 11:40:20', 4, '2015-11-16 10:22:29'),
(32, 1, 3, 'n', 'no car', '2015-10-05 11:40:20', 4, '2015-10-05 11:40:20', 4, '2015-11-16 10:22:29'),
(29, 1, 19, '', 'artists', '2015-10-05 11:38:13', 4, '2015-10-05 11:38:13', 4, '2015-11-16 10:22:29'),
(28, 1, 22, '', '20000000', '2015-10-05 11:35:41', 4, '2015-10-05 11:35:41', 4, '2015-11-16 10:22:29'),
...
(104, 1, 24, '', 'health care, gym, movie, annual trip, life insurance', '2015-11-16 16:44:00', 4, '2015-11-16 16:44:00', 4, '2015-11-16 10:22:29'),
(103, 2, 23, '', 'asap', '2015-10-21 16:43:42', 5, '2015-10-21 16:43:42', 5, '2015-10-21 09:43:42'),
(105, 1, 25, '', 'better than before', '2015-11-16 16:44:00', 4, '2015-11-16 16:44:00', 4, '2015-11-16 10:22:29');
