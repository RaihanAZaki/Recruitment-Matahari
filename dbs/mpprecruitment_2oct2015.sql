...
--
-- Host: localhost
-- Generation Time: Oct 02, 2015 at 05:40 PM
...
INSERT INTO `log_auth` (`log_auth_id`, `employee_id`, `log_auth_name`, `log_auth_passwd`, `log_auth_role`, `log_auth_lastlogin`, `log_auth_lastip`, `register_id`, `register_date`, `register_activation_code`, `status_id`, `user_insert`, `date_insert`, `user_update`, `date_update`) VALUES
(1, 1, 'shakti.santoso@hypermart.co.id', 'E/Pe9Q/bKhPyeTuIifQm8/KqNJzFmUW217G5qXxLcM6', 'admin', '2015-09-15 09:12:07', 'ThinkPadShakti / 127.0.0.1', 0, '2015-09-10 10:18:37', 'activationcode', 'active', 1, '2015-09-10 10:19:06', 1, '2015-09-10 03:19:27'),
(2, 2, 'hris.msm@hypermart.co.id', 'kZyJHzr7.4k52vXKLo1HrPs8G.jqFtAbsWc7iV.5cd6', 'hrd', '2015-09-10 03:40:53', '172.0.0.1', 0, '2015-09-10 10:41:08', 'activationcode', 'active', 1, '2015-09-10 10:41:22', 1, '2015-09-10 03:41:24'),
(3, 3, 'mateus.liem@hypermart.co.id', 'Oz3tJUZmx6rIOTEFfggfv9R/2k124sISSq7NIR0t5n/', 'pic', '2015-09-10 03:48:27', '172.0.0.1', 0, '2015-09-10 10:48:38', 'activationcode', 'active', 1, '2015-09-10 10:48:47', 1, '2015-09-10 03:48:49'),
(4, 0, 'shakti_santoso@yahoo.com', 'NedhoPZKYRsn90FqLo/iKlA5RDx0c9NwTjZU0NLRHPA', 'candid', '2015-10-02 10:32:26', 'TimothyGabrielB / 127.0.0.1', 1, '2015-09-14 00:00:00', 'actcode', 'active', 1, '2015-09-14 00:00:00', 1, '2015-09-14 01:54:18');
...
CREATE TABLE IF NOT EXISTS `m_candidate` (
  ...
  `candidate_religion` varchar(15) NOT NULL,
  ...
  `candidate_hp1` varchar(15) NOT NULL,
  `candidate_hp2` varchar(15) NOT NULL,
...
(1, 4, 'Shakti Candidate', 'shakti_santoso@yahoo.com', 'male', 'Roman Catholic', 'Yogyakarta', '1981-04-12', 'Javanese', 'wni', 'Indonesia', 'KTP', '1234567890123456', 'Married', '165.00', '70.00', 'A+', '123456789111', '123456789222', '123456789012345', 'Kumetiran Kidul GT 2 No. 774\\r\\nYogyakarta\\r\\n55272\\r\\n', 'Kota Yogyakarta', '55272', 'Sukamandiri\\r\\nNo. 29', 'Kota Tangerang Selatan', '', '085647848573', '083877750802', '', 'Lindi', 'Wife', '083871186400', 'Lian Sien', 'Mother', '081915533774', 'makan\\r\\ntidur\\r\\njajan', 'active', 4, '2015-09-14 10:14:27', 4, '2015-09-30 09:07:15');
...
(4, 1, 'Son', 'Pradipto Wiro Seno', 'Kota Tangerang Selatan', '2015-06-13', '', 'Baby', 'family', 'Alive', 4, '2015-10-01 11:19:53', 4, '2015-10-01 04:26:58'),
(3, 1, 'Mother', 'Tri Nurdhayati', 'Kota Yogyakarta', '1952-09-29', 'Highschool - SMA', 'Housewife', 'family', 'Alive', 4, '2015-10-01 11:19:53', 4, '2015-10-01 04:26:58'),
(2, 1, 'Spouse', 'Laurensia Lindi', 'Jakarta Timur', '1984-09-07', 'Master Degree - S2', 'Konselor', 'UMN', 'Alive', 4, '2015-10-01 11:19:53', 4, '2015-10-01 04:26:58'),
(1, 1, 'Father', 'Moh. Santoso', 'Kota Yogyakarta', '1948-12-19', 'Highschool - SMA', 'Wiraswasta', 'AU', 'Alive', 4, '2015-10-01 11:19:53', 4, '2015-10-01 04:26:58');
...
(2, 1, 'coverletter20150929123739_1.pdf', 'coverletter', 4, '2015-09-29 12:02:40', 4, '2015-09-29 05:37:39'),
...
(5, 1, 'idcard20150929155112_1.jpg', 'idcard', 4, '2015-09-29 12:52:13', 4, '2015-09-29 08:51:12');
...
CREATE TABLE IF NOT EXISTS `m_candidate_jobexp` (
  ...
  `candidate_jobexp_phone` varchar(13) DEFAULT NULL,
...
(1, 1, 'English', 'Advance', 'Advance', 'Intermediate', 4, '2015-10-01 09:48:35', 4, '2015-10-01 04:25:26'),
(3, 1, 'Java', 'Elementary', 'Elementary', 'Master', 4, '2015-10-01 11:25:26', 4, '2015-10-01 04:25:26');
...
(2, 1, 'Gregorius Caecilia Choir', 'Officer', '2001', '2013', 4, '2015-09-25 08:59:25', 4, '2015-10-02 07:58:46'),
(1, 1, 'Toastmasters International', 'Vice President', '2011', '2015', 4, '2015-09-30 17:30:26', 4, '2015-10-02 07:58:46');
...
(1, 1, 'Debus Banten', 'Advance', 'Belajar debus dengan ceria dan gembira.\\r\\n\\r\\nDilatih langsung sama Limbad.', 4, '2015-09-25 10:35:50', 4, '2015-10-01 04:28:54'),
(3, 1, 'Totok wajah', 'Beginner', 'notok wajah sekali langsung cakep', 4, '2015-10-01 09:14:05', 4, '2015-10-01 04:28:54');
...
(3, 1, 'Mateus Liem', '90001', 'mateus.liem@hypermart.co.id', 'active', 1, '2015-09-10 10:47:01', 1, '2015-09-10 03:47:03');
...
(4, 'detail', 'Detail Job Vacancy', NULL, 'ds.vacancydetail.php', 'n', 'primary', 'n', 11, 0, 'fa-bookmark', 'kuning', NULL, 'n', 'active', 1, '2015-09-15 13:28:16', 1, '2015-09-15 06:32:13'),
(5, 'changepasswd', 'Change Password', NULL, 'ds.changepasswd.php', 'n', 'inner', 'n', 10, 0, 'fa-unlock-alt', 'grey', NULL, 'n', 'inactive', 1, '2015-09-15 09:06:52', 1, '2015-09-15 06:32:10'),
(6, 'howtoapply', 'How to Apply', '', 'ds.howto.php', 'n', 'primary', 'y', 3, 0, 'fa-check', 'kuning', '', 'n', 'active', 1, '2015-09-07 00:00:00', 1, '2015-09-15 06:31:58'),
(7, 'faq', 'Frequently Asked Question', '', 'ds.faq.php', 'n', 'primary', 'y', 4, 0, 'fa-question-circle', 'kuning', '', 'n', 'active', 1, '2015-09-07 00:00:00', 1, '2015-09-15 06:31:53'),
(8, 'contactus', 'Contact Us', '', 'ds.contactus.php', 'n', 'primary', 'y', 5, 0, 'fa-envelope', 'kuning', '', 'n', 'active', 1, '2015-09-07 00:00:00', 1, '2015-09-15 06:31:51'),
(9, 'register', 'Registration', '', 'ds.register.php', 'n', 'upperight', 'y', 1, 0, 'fa-user', 'orange', '', 'n', 'active', 1, '2015-09-09 14:41:29', 1, '2015-09-21 02:19:28'),
(10, 'resendactivation', 'Resend Activation Email', '', 'ds.resendactivation.php', 'n', 'upperight', 'y', 2, 0, 'fa-paper-plane', 'orange', NULL, 'n', 'active', 1, '2015-09-10 11:39:15', 1, '2015-09-15 06:31:44'),
(11, 'forgotpwd', 'Forgot Password', NULL, 'ds.forgotpwd.php', 'n', 'upperright', 'y', 3, 0, 'fa-lightbulb-o', 'orange', NULL, 'n', 'active', 1, '2015-09-10 11:42:36', 1, '2015-09-15 06:31:42'),
(12, 'login', 'Login', NULL, 'ds.loginfrm.php', 'n', 'upperight', 'n', 4, 0, 'fa-lock', 'orange', NULL, 'n', 'active', 1, '2015-09-10 11:51:50', 1, '2015-09-15 06:31:39'),
...
(24, 'admlogin', 'Login Admin', NULL, 'adm.login.php', 'n', 'admprimary', 'y', 1, 0, 'fa-lock', 'grey', '', 'n', 'active', 1, '2015-09-10 14:11:10', 1, '2015-10-02 10:31:47'),
(25, 'admhome', 'Dashboard', NULL, 'adm.home.php', 'y', 'admprimary', 'y', 2, 0, 'fa-home', 'grey', 'sortir', 'n', 'active', 1, '2015-09-10 13:52:39', 1, '2015-10-02 10:31:43'),
(26, 'screening', 'Screening', NULL, 'adm.screening.php', 'y', 'admprimary', 'y', 3, 0, 'fa-filter', 'grey', 'sortir', 'n', 'active', 1, '2015-09-10 13:54:43', 1, '2015-10-02 10:31:39'),
...
INSERT INTO `m_question` (`question_id`, `question_chapter`, `question_desc`, `question_deskripsi`, `question_type`, `question_order`, `status_id`, `user_insert`, `date_insert`, `user_update`, `date_update`) VALUES
(1, 1, 'Own a house?', 'MEMILIKI RUMAH ?', 'yn_desc', 1, 'active', 1, '2015-10-02 16:32:53', 1, '2015-10-02 09:36:40'),
(2, 1, 'Own a plot of land ?', 'MEMILIKI SEBIDANG TANAH ?', 'yn_desc', 2, 'active', 1, '2015-10-02 16:35:50', 1, '2015-10-02 09:36:45'),
(3, 1, 'Own a car?', 'MEMILIKI MOBIL?', 'yn_desc', 3, 'active', 1, '2015-10-02 16:37:23', 1, '2015-10-02 09:37:25'),
(4, 1, 'Own a motorcycle?', 'MEMILIKI SEPEDA MOTOR?', 'yn_desc', 4, 'active', 1, '2015-10-02 16:38:10', 1, '2015-10-02 09:38:12'),
(5, 1, 'Rent a house?', 'MENYEWA RUMAH?', 'yn_desc', 5, 'active', 1, '2015-10-02 16:38:47', 1, '2015-10-02 09:38:49'),
(6, 1, 'Reside in a house owned by company?', 'TINGGAL DI RUMAH MILIK PERUSAHAAN', 'yn_desc', 6, 'active', 1, '2015-10-02 16:39:36', 1, '2015-10-02 09:39:37'),
(7, 1, 'Use a car/ motorcycle owned by company?', 'MENGGUNAKAN MOBIL/ MOTOR MILIK PERUSAHAAN', 'yn_desc', 7, 'active', 1, '2015-10-02 16:40:29', 1, '2015-10-02 09:40:31'),
(8, 2, 'Have you previously applied to our company? If so, when and what position?', 'APAKAH ANDA PERNAH MELAMAR PADA PERUSAHAAN INI SEBELUMNYA? BILAMANA DAN SEBAGAI APA?', 'yn_desc', 1, 'active', 1, '2015-10-02 16:45:52', 1, '2015-10-02 09:45:53'),
(9, 2, 'Are you also applying to other companies? If yes, please mention what companies and position applied.', 'SELAIN DI SINI, DI PERUSAHAAN MANA LAGI ANDA MELAMAR SAAT SEBELUMNYA? BILAMANA DAN SEBAGAI APA?', 'yn_desc', 2, 'active', 1, '2015-10-02 16:47:41', 1, '2015-10-02 09:47:43'),
(10, 2, 'Are you under any contract agreement with other companies?', 'APAKAH ANDA TERIKAT KONTRAK DENGAN PERUSAHAAN TEMPAT KERJA SAAT INI?', 'yn_desc', 3, 'active', 1, '2015-10-02 16:48:45', 1, '2015-10-02 09:50:41'),
(11, 2, 'Do you have any part-time job? Specify the name of the company and position mentioned.', 'APAKAH ANDA MEMPUNYAI PEKERJAAN SAMPINGAN/ PART TIME? DI MANA DAN SEBAGAI APA?', 'yn_desc', 4, 'active', 1, '2015-10-02 16:50:32', 1, '2015-10-02 09:50:34'),
(12, 2, 'Do you have any objections if we contact your previous employer for reference checking? Please mention name and cellular number your reference', 'APAKAH ANDA BERKEBERATAN BILA KAMI MINTA REFERENSI PADA PERUSAHAAN TEMPAT ANDA PERNAH BEKERJA? SEBUTKAN NAMA YANG DAPAT MENJADI REFERENSI ANDA.', 'yn_desc', 5, 'active', 1, '2015-10-02 16:52:32', 1, '2015-10-02 09:52:41'),
(13, 2, 'Do you have any acquaintance(s) or relative(s) employed by our company? Please, mention name and your relationship.', 'APAKAH ANDA MEMPUNYAI TEMAN/ SANAK SAUDARA YANG BEKERJA PADA PERUSAHAAN INI? SEBUTKAN NAMA DAN HUBUNGAN ANDA.', 'yn_desc', 6, 'active', 1, '2015-10-02 16:55:36', 1, '2015-10-02 09:55:39'),
(14, 2, 'What serious illness/ surgeries/ accidents have you ever had?', 'APAKAH ANDA PERNAH MENDERITA SAKIT KERAS/ KRONIS/ KECELAKAAN BERAT/ OPERASI? BILAMANA DAN MACAM APA? JELASKAN.', 'yn_desc', 7, 'active', 1, '2015-10-02 16:57:05', 1, '2015-10-02 09:57:07'),
(15, 2, 'Have you ever undergone any psychological tests before? If so, when, where, and for what purpose?', 'APAKAH ANDA PERNAH MENJALANI PEMERIKSAAN PSIKOLOGIS/ PSIKOTES? BILAMA, DI MANA, DAN UNTUK TUJUAN APA?', 'yn_desc', 8, 'active', 1, '2015-10-02 17:04:56', 1, '2015-10-02 10:04:58'),
(16, 2, 'Have you ever been involved in any administrative, civil, or criminal case?', 'APAKAH ANDA PERNAH BERURUSAN DENGAN POLISI KARENA TINDAK KEJAHATAN?', 'yn_desc', 9, 'active', 1, '2015-10-02 17:06:26', 1, '2015-10-02 10:06:28'),
(17, 2, 'If accepted, do you agree to out to Jakarta assignment?', 'BILA DITERIMA, BERSEDIAKAH ANDA BERTUGAS KE LUAR KOTA?', 'yn_desc', 10, 'active', 1, '2015-10-02 17:07:43', 1, '2015-10-02 10:07:44'),
(18, 2, 'If accepted, do you agree to be located anywhere in Indonesia? Please mention prefered cities of region.', 'BILA DITERIMA, BERSEDIAKAH ANDA DITEMPATKAN DI SELURUH DAERAH DI INDONESIA? SEBUTKAN NAMA KOTA DAN DAERAH YANG LEBIH DISUKAI.', 'yn_des', 11, 'active', 1, '2015-10-02 17:10:05', 1, '2015-10-02 10:10:19'),
(19, 2, 'Describe any kind of jobs that are in line with your career plan.', 'MACAM PEKERJAAN/ JABATAN APAKAH YANG SESUAI DENGAN CITA-CITA ANDA?', 'txt_area', 12, 'active', 1, '2015-10-02 17:13:59', 1, '2015-10-02 10:14:01'),
(20, 2, 'Describe any kind of jobs that you don\\''t like.', 'MACAM PEKERJAAN/ BAGAIMANAKAH YANG TIDAK ANDA SUKAI?', 'txt_area', 13, 'active', 1, '2015-10-02 17:15:48', 1, '2015-10-02 10:15:50'),
(21, 2, 'Please state your current monthly income and facilities.', 'BERAPA BESARKAH PENGHASILAN ANDA SEBULAN, DAN FASILITAS APA SAJA YANG ANDA PEROLEH SAAT INI?', 'txt_area', 14, 'active', 1, '2015-10-02 17:16:56', 1, '2015-10-02 10:16:57'),
(22, 2, 'State salary and facilities desired.', 'BILA DITERIMA, BERAPA GAJI DAN FASILITAS APA YANG ANDA HARAPKAN?', 'txt_area', 15, 'active', 1, '2015-10-02 17:18:13', 1, '2015-10-02 10:18:15'),
(23, 2, 'If accepted, when you can start working?', 'BILA DITERIMA, KAPAN ANDA DAPAT MULAI BEKERJA?', 'txt_area', 16, 'active', 1, '2015-10-02 17:19:21', 1, '2015-10-02 10:19:22');
...
CREATE TABLE IF NOT EXISTS `m_register` (
  ...
  `candidate_hp1` varchar(15) NOT NULL,
  `candidate_hp2` varchar(15) NOT NULL,
  `candidate_phone` varchar(12) NOT NULL,
  `register_date` datetime NOT NULL,
...
CREATE TABLE IF NOT EXISTS `t_apply_history` (
  ...
  `apply_history_notes` varchar(250) NOT NULL,
  `user_insert` int(11) NOT NULL,
  `date_insert` datetime NOT NULL,
  `user_update` int(11) NOT NULL,
  `date_update` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
