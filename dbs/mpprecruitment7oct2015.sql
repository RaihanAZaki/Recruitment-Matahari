...
--
-- Host: localhost
-- Generation Time: Oct 07, 2015 at 05:29 PM
...
(4, 0, 'shakti_santoso@yahoo.com', 'NedhoPZKYRsn90FqLo/iKlA5RDx0c9NwTjZU0NLRHPA', 'candid', '2015-10-07 10:24:13', 'TimothyGabrielB / 127.0.0.1', 1, '2015-09-14 00:00:00', 'actcode', 'active', 0, '2015-09-14 00:00:00', 1, '2015-09-14 01:54:18'),
(5, 0, 'shaktisantoso@gmail.com', '2hyk3VU6ylVcB3p7BD5xjqiHuoPweN5ipmpQZQBZv57', 'candid', '2015-10-07 10:26:48', 'TimothyGabrielB / 127.0.0.1', 4, '2015-10-07 17:13:03', '$5$rounds=5000$8d813f7cde0b7f9c$CW.rgvIIKd8rXZr6T0hAiCdhGU9B5TeV1kf5IFBQJh7', 'active', 0, '2015-10-07 17:13:03', 0, '2015-10-07 17:13:03');
...
(2, 5, 'Shakti Suryo', 'shaktisantoso@gmail.com', 'male', 'Roman Catholic', 'Kota Yogyakarta', '1987-04-12', 'Javanese', 'wni', 'Indonesia', 'KTP', '1234567890123457', 'Married', '100.00', '30.00', '', '', '', '', 'Yogyakarta ajah', 'Kota Yogyakarta', '', 'ciputat', 'Kota Tangerang Selatan', '', '085647848572', '', '', 'julius', 'Father', '123', '', '', '', 'ini hobi', 'active', 5, '2015-10-07 17:13:03', 5, '2015-10-07 10:23:39');
...
CREATE TABLE IF NOT EXISTS `m_register` (
  ...
  `candidate_idcard` varchar(16) NOT NULL,
  `candidate_hp1` varchar(15) NOT NULL,
  `candidate_hp2` varchar(15) DEFAULT NULL,
  `candidate_phone` varchar(12) DEFAULT NULL,
  `register_date` datetime NOT NULL,
  `register_activation_date` datetime NOT NULL,
