		...
		if(isset($_POST["candidate_id"]) && $_POST["candidate_id"]<>"") {
			...
			*/
			...
			if (count($datasiblings) > 0) {
				...
				// Jika tidak ada data siblings, tampilkan pesan informasi
				$html .= '
				<tr>
					<td colspan="7" height="35px" style="border: 0.1mm solid black; text-align: center;">
						Tidak ada data siblings / No sibling data available
					</td>
				</tr>
				';
			}
					  ...
					  <tr>
						...
						<table width="180px" cellpadding="3" cellspacing="0" >
						  <tr>
							...
							// Check if candidate expected salary is available
							if (isset($dataresume[0]["candidate_expected_salary"]) && $dataresume[0]["candidate_expected_salary"] <> "" && $dataresume[0]["candidate_expected_salary"] > 0) {
								$html .= showRupiah($dataresume[0]["candidate_expected_salary"]);
							} else {
							...
							// Display candidate photo if available, else show default image
							if (isset($dataphoto["id"]) && isset($dataphoto["name"]) && $dataphoto["name"] <> "") {
							...
							} elseif ($dataresume[0]["candidate_gender"] == 'female') {
						...
						<table width="700px" style="font-family: serif;font-size:10px;" cellpadding="3" cellspacing="0">
							<tr>
								<td width="170px" height="20px" style="border: 0.1mm solid black;" align="left">
									<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
										<tr>
											<td width="100px" height="30">TANGGAL LAHIR<br />Date of birth</td>
											<td width="10px">:</td>
											<td>' . reverseDate($dataresume[0]["candidate_birthdate"]) . '</td>
										</tr>
									</table>
									...
									<td width="70%" height="20px" style="border: 0.1mm solid black;" >
										<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
											<tr>
												...
												<td width="55%">'.$dataresume[0]["candidate_c_address"].' - '.$dataresume[0]["candidate_c_city"].' - '.$dataresume[0]["candidate_c_postcode"].'</td>
											</tr>
										</table>
									</td>
									...
									<td width="70%" height="20px" style="border: 0.1mm solid black;" >
										<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
											<tr>
												...
												<td width="45%">'.$dataresume[0]["candidate_p_address"].' - '.$dataresume[0]["candidate_p_city"].' - '.$dataresume[0]["candidate_p_postcode"].'</td>
											</tr>
										</table>
									</td>
									<td width="30%" height="20px" style="border: 0.1mm solid black;" >
