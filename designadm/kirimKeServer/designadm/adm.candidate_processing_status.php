					...
					<table border="0">
						...
						<tr>
							...
							<td style="padding-bottom:20px;">
								...
								<select name="candidate_apply_status" id="candidate_apply_status" class="form-control input-sm" <?php if($candidate_apply_stage=="offering")  echo "onChange='ifJoin(this);'"; ?>>
								<?php
								if($candidate_apply_stage=="offering") {
								?>
									<option value="ongoing" <?php if ($candidate_apply_status=="ongoing") echo "selected";?> >ON GOING</option>
									<option value="join" <?php if ($candidate_apply_status=="join") echo "selected";?> >JOIN</option>
									<option value="disjoin" <?php if ($candidate_apply_status=="disjoin") echo "selected";?> >DISJOIN</option>
								<?php
								}
								else {
								?>	
							...
							<td colspan="5" style="padding:0; margin:0;">
								<table width="100%">
									...
									<tr>
										...
										<td></td>
										<td style="padding-bottom:20px;">
											<input type="checkbox" name="send_invitation" id="send_invitation" disabled="disabled" value="y"/>
							...
							<td colspan="5" style="padding:0; margin:0;" align="left">
								<table border="0" width="100%">
									...
									<tr>
										...
										<td style="width:10px; padding-bottom:20px;">:</td>										
										<td style="padding-bottom:20px;" colspan="3"><input name="LocationCode" id="LocationCode" class="form-control input-sm"></td>
									</tr>
...
$(document).ready(function(){
	...
	$("#candidate_apply_status").change(function(){		
                $( "#candidate_apply_status option:selected").each(function(){
                    ...
                    if($(this).attr("value")=="pass" || $(this).attr("value")=="reject"){
						...
						var candidate_apply_stage = "<?php echo showStageName(adm_getNextStage($candidate_apply_stage));?>" + " stage ";
						...
						if($("#candidate_apply_status").val() == "pass") {
							/*alert('sini pass');*/
						...
						if($("#candidate_apply_status").val()== "reject") {
							//alert('sini reject');
							var rejecttitle;
							var rejectcontent;
