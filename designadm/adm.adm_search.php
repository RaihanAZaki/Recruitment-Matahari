...
<div class="panel panel-default">
		...
		<table class="table table-striped table-condensed">
			<thead>
				<tr>
					...
					<?php
					if( (isset($_GET["candidate_edu_degree"]) && $_GET["candidate_edu_degree"]<>"") || (isset($_GET["candidate_edu_major"]) && $_GET["candidate_edu_major"]<>"")  ) {
					?>
					<td><b>Degree</b></td>
					...
					if(isset($_GET["candidate_edu_end1"]) && $_GET["candidate_edu_end1"]<>"" && isset($_GET["candidate_edu_end2"]) && $_GET["candidate_edu_end2"]<>""){
					?>
			...
			?>
				<tr>
					...
					if( (isset($_GET["candidate_edu_degree"]) && $_GET["candidate_edu_degree"]<>"")  || (isset($_GET["candidate_edu_major"]) && $_GET["candidate_edu_major"]<>"") ) {
					?>
					<td><?php echo $datacandidate[$i]["degree_name"];?></td>	
					<td><?php echo $datacandidate[$i]["candidate_edu_institution"];?></td>	
					<td><?php echo $datacandidate[$i]["edu_major"];?></td>	
					<?php
					}
					if(isset($_GET["candidate_edu_end1"]) && $_GET["candidate_edu_end1"]<>"" && isset($_GET["candidate_edu_end2"]) && $_GET["candidate_edu_end2"]<>""){
					?>
					<td><?php echo $datacandidate[$i]["candidate_edu_end"];?></td>
					<?php
					}
					?>
					<td align="center">
	...
	<div class="panel-footer">
		...
		if(isset($_GET["candidate_edu_major"]) && $_GET["candidate_edu_major"]<>"") {
			$linknya .="&candidate_edu_major=".$_GET["candidate_edu_major"];
		}

		if(isset($_GET["candidate_edu_end1"]) && $_GET["candidate_edu_end1"]<>"" && isset($_GET["candidate_edu_end2"]) && $_GET["candidate_edu_end2"]<>"") {
			$linknya .="&candidate_edu_end1=".$_GET["candidate_edu_end1"];
			$linknya .="&candidate_edu_end2=".$_GET["candidate_edu_end2"];
		}		
