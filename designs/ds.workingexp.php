...
// $data[$i]["candidate_jobexp_id"] = (isset($_SESSION["session"]["candidate_jobexp_id"][$i]) && $_SESSION["session"]["candidate_jobexp_id"][$i] !== "")?$_SESSION["session"]["candidate_jobexp_id"][$i]:(isset($datajob[$i]["candidate_jobexp_id"]))?$datajob[$i]["candidate_jobexp_id"]:"";
// $data[$i]["candidate_jobexp_company"]=(isset($_SESSION["session"]["candidate_jobexp_company"][$i]) && $_SESSION["session"]["candidate_jobexp_company"][$i]<>"")?$_SESSION["session"]["candidate_jobexp_company"][$i]:(isset($datajob[$i]["candidate_jobexp_company"]))?$datajob[$i]["candidate_jobexp_company"]:"";
// $data[$i]["candidate_jobexp_address"]=(isset($_SESSION["session"]["candidate_jobexp_address"][$i]) && $_SESSION["session"]["candidate_jobexp_address"][$i]<>"")?$_SESSION["session"]["candidate_jobexp_address"][$i]:(isset($datajob[$i]["candidate_jobexp_address"]))?$datajob[$i]["candidate_jobexp_address"]:"";
// $data[$i]["candidate_jobexp_phone"]=(isset($_SESSION["session"]["candidate_jobexp_phone"][$i]) && $_SESSION["session"]["candidate_jobexp_phone"][$i]<>"")?$_SESSION["session"]["candidate_jobexp_phone"][$i]:(isset($datajob[$i]["candidate_jobexp_phone"]))?$datajob[$i]["candidate_jobexp_phone"]:"";
// $data[$i]["candidate_jobexp_lob"]=(isset($_SESSION["session"]["candidate_jobexp_lob"][$i]) && $_SESSION["session"]["candidate_jobexp_lob"][$i]<>"")?$_SESSION["session"]["candidate_jobexp_lob"][$i]:(isset($datajob[$i]["candidate_jobexp_lob"]))?$datajob[$i]["candidate_jobexp_lob"]:"00.00";
// $data[$i]["candidate_jobexp_numemployee"]=(isset($_SESSION["session"]["candidate_jobexp_numemployee"][$i]) && $_SESSION["session"]["candidate_jobexp_numemployee"][$i]<>"")?$_SESSION["session"]["candidate_jobexp_numemployee"][$i]:(isset($datajob[$i]["candidate_jobexp_numemployee"]))?$datajob[$i]["candidate_jobexp_numemployee"]:"";
// $data[$i]["candidate_jobexp_spvname"]=(isset($_SESSION["session"]["candidate_jobexp_spvname"][$i]) && $_SESSION["session"]["candidate_jobexp_spvname"][$i]<>"")?$_SESSION["session"]["candidate_jobexp_spvname"][$i]:(isset($datajob[$i]["candidate_jobexp_spvname"]))?$datajob[$i]["candidate_jobexp_spvname"]:"";
// $data[$i]["candidate_jobexp_spvposition"]=(isset($_SESSION["session"]["candidate_jobexp_spvposition"][$i]) && $_SESSION["session"]["candidate_jobexp_spvposition"][$i]<>"")?$_SESSION["session"]["candidate_jobexp_spvposition"][$i]:(isset($datajob[$i]["candidate_jobexp_spvposition"]))?$datajob[$i]["candidate_jobexp_spvposition"]:"";
// $data[$i]["candidate_jobexp_subposition"]=(isset($_SESSION["session"]["candidate_jobexp_subposition"][$i]) && $_SESSION["session"]["candidate_jobexp_subposition"][$i]<>"")?$_SESSION["session"]["candidate_jobexp_subposition"][$i]:(isset($datajob[$i]["candidate_jobexp_subposition"]))?$datajob[$i]["candidate_jobexp_subposition"]:"";
// $data[$i]["candidate_jobexp_subnumber"]=(isset($_SESSION["session"]["candidate_jobexp_subnumber"][$i]) && $_SESSION["session"]["candidate_jobexp_subnumber"][$i]<>"")?$_SESSION["session"]["candidate_jobexp_subnumber"][$i]:(isset($datajob[$i]["candidate_jobexp_subnumber"]))?$datajob[$i]["candidate_jobexp_subnumber"]:"";
// $data[$i]["candidate_jobexp_position"]=(isset($_SESSION["session"]["candidate_jobexp_position"][$i]) && $_SESSION["session"]["candidate_jobexp_position"][$i]<>"")?$_SESSION["session"]["candidate_jobexp_position"][$i]:(isset($datajob[$i]["candidate_jobexp_position"]))?$datajob[$i]["candidate_jobexp_position"]:"";
// $data[$i]["candidate_jobexp_desc"]=(isset($_SESSION["session"]["candidate_jobexp_desc"][$i]) && $_SESSION["session"]["candidate_jobexp_desc"][$i]<>"")?$_SESSION["session"]["candidate_jobexp_desc"][$i]:(isset($datajob[$i]["candidate_jobexp_desc"]))?$datajob[$i]["candidate_jobexp_desc"]:"";
// $data[$i]["candidate_jobexp_salary"]=(isset($_SESSION["session"]["candidate_jobexp_salary"][$i]) && $_SESSION["session"]["candidate_jobexp_salary"][$i]<>"")?$_SESSION["session"]["candidate_jobexp_salary"][$i]:(isset($datajob[$i]["candidate_jobexp_salary"]))?$datajob[$i]["candidate_jobexp_salary"]:"";
// $data[$i]["candidate_jobexp_start"]=(isset($_SESSION["session"]["candidate_jobexp_start"][$i]) && $_SESSION["session"]["candidate_jobexp_start"][$i]<>"")?$_SESSION["session"]["candidate_jobexp_start"][$i]:(isset($datajob[$i]["candidate_jobexp_start"]))?$datajob[$i]["candidate_jobexp_start"]:"";
// $data[$i]["candidate_jobexp_end"]=(isset($_SESSION["session"]["candidate_jobexp_end"][$i]) && $_SESSION["session"]["candidate_jobexp_end"][$i]<>"")?$_SESSION["session"]["candidate_jobexp_end"][$i]:(isset($datajob[$i]["candidate_jobexp_end"]))?$datajob[$i]["candidate_jobexp_end"]:"";
// $data[$i]["candidate_jobexp_leaving"]=(isset($_SESSION["session"]["candidate_jobexp_leaving"][$i]) && $_SESSION["session"]["candidate_jobexp_leaving"][$i]<>"")?$_SESSION["session"]["candidate_jobexp_leaving"][$i]:(isset($datajob[$i]["candidate_jobexp_leaving"]))?$datajob[$i]["candidate_jobexp_leaving"]:"";
$data[$i]["candidate_jobexp_id"] = (isset($_SESSION["session"]["candidate_jobexp_id"][$i]) && $_SESSION["session"]["candidate_jobexp_id"][$i] !== "") ? $_SESSION["session"]["candidate_jobexp_id"][$i] : ((isset($datajob[$i]["candidate_jobexp_id"])) ? $datajob[$i]["candidate_jobexp_id"] : "");
$data[$i]["candidate_jobexp_company"] = (isset($_SESSION["session"]["candidate_jobexp_company"][$i]) && $_SESSION["session"]["candidate_jobexp_company"][$i] !== "") ? $_SESSION["session"]["candidate_jobexp_company"][$i] : ((isset($datajob[$i]["candidate_jobexp_company"])) ? $datajob[$i]["candidate_jobexp_company"] : "");
$data[$i]["candidate_jobexp_address"] = (isset($_SESSION["session"]["candidate_jobexp_address"][$i]) && $_SESSION["session"]["candidate_jobexp_address"][$i] !== "") ? $_SESSION["session"]["candidate_jobexp_address"][$i] : ((isset($datajob[$i]["candidate_jobexp_address"])) ? $datajob[$i]["candidate_jobexp_address"] : "");
$data[$i]["candidate_jobexp_phone"] = (isset($_SESSION["session"]["candidate_jobexp_phone"][$i]) && $_SESSION["session"]["candidate_jobexp_phone"][$i] !== "") ? $_SESSION["session"]["candidate_jobexp_phone"][$i] : ((isset($datajob[$i]["candidate_jobexp_phone"])) ? $datajob[$i]["candidate_jobexp_phone"] : "");
...
<div class="panel panel-info" style="margin-bottom:30px;">
	<div class="panel-heading">
		<h2 class="panel-title"><cufonize><i class="fa fa-graduation-cap"></i>&nbsp;Please list <b>3</b> of your Working Experiences started from the latest one.</cufonize></h2>
		<div class="caption_indo">Mohon tuliskan <b>3</b> pengalaman kerja Anda, dimulai dari yang terbaru.</div>
	</div>
			...
			<div class="form-group">
				...
				?>
					<div id="experience_<?php echo $i;?>" class="bottom10 top10">
						...
						<div class="form-group">
							<div class="col-md-2">
								<div class="right bold">Company &nbsp;<span class="asterisk">*</span></div>
								<div class="right caption_indo80 novpadding" style="padding-right:15px;">Perusahaan</div>
							</div>
							<div class="col-sm-4">
							...
							<div class="col-md-2">
								<div class="right bold">Start / End &nbsp;<span class="asterisk">*</span></div>
								<div class="right caption_indo80 novpadding" style="padding-right:15px;">Masuk/Keluar</div>
							</div>
							<div class="col-md-2">
						...
						<div class="form-group">
							<div class="col-md-2">
								<div class="right bold">Industry &nbsp;<span class="asterisk">*</span></div>
								<div class="right caption_indo80 novpadding" style="padding-right:15px;">Industri</div>
							</div>
							<div class="col-sm-4">
							...
							<div class="col-md-2">
								<div class="right bold">Position &nbsp;<span class="asterisk">*</span></div>
								<div class="right caption_indo80 novpadding" style="padding-right:15px;">Jabatan</div>
							</div>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<div class="col-md-2">
								<div class="right bold">Address&nbsp;&nbsp;&nbsp;&nbsp;</div>
								<div class="right caption_indo80 novpadding" style="padding-right:15px;">Alamat</div>
							</div>
							<div class="col-sm-4">
							...
							<div class="col-md-2">
								<div class="right bold" style="line-height:100%;">Job Description / Task &nbsp;<span class="asterisk">*</span></div>
								<div class="right caption_indo80" style="line-height:100%;">Deskripsi Pekerjaan/Tugas</div>
							</div>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<div class="col-md-2">
								<div class="right bold">Phone&nbsp;&nbsp;&nbsp;&nbsp;</div>
								<div class="right caption_indo80 novpadding" style="padding-right:15px;">Telepon</div>
							</div>
							<div class="col-sm-4">
							...
							<div class="col-md-2">
								<div class="right bold">Salary</div>
								<div class="right caption_indo80 novpadding">Gaji Bulanan</div>
							</div>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<div class="col-md-2">
								<div class="right bold"># Employee&nbsp;&nbsp;&nbsp;&nbsp;</div>
								<div class="right caption_indo80 novpadding" style="padding-right:15px;"># Karyawan</div>
							</div>
							<div class="col-sm-4">
							...
							<div class="col-md-2">
								<div class="right bold"># Subordinate</div>
								<div class="right caption_indo80 novpadding"># Anak buah</div>
							</div>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<div class="col-md-2">
								<div class="right bold">Spv. Name&nbsp;&nbsp;&nbsp;&nbsp;</div>
								<div class="right caption_indo80 novpadding" style="padding-right:15px;">Nama Spv</div>
							</div>
							<div class="col-sm-4">
							...
							<div class="col-md-2">
								<div class="right bold">Sub. Position</div>
								<div class="right caption_indo80 novpadding">Jbtn. SubOrd</div>
							</div>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<div class="col-md-2">
								<div class="right bold">Spv. Position&nbsp;&nbsp;&nbsp;&nbsp;</div>
								<div class="right caption_indo80 novpadding" style="padding-right:15px;">Jbtn. Spv</div>
							</div>
							<div class="col-sm-4">
							...
							<div class="col-md-2">
								<div class="right bold" style="line-height:100%;">Leaving reason</div>
								<div class="right caption_indo80" style="line-height:100%;">Alasan resign</div>
							</div>
							<div class="col-sm-4">
				...
				?>
			<input type="hidden" name="mod" value="update_candidateJobexp" />
