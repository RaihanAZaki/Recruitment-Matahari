...
<div class="panel panel-info" style="margin-bottom:30px;">
	<div class="panel-heading">
		<h2 class="panel-title"><cufonize><i class="fa fa-pencil-square-o"></i>&nbsp;Please complete the questionaire below.</cufonize></h2>
		<div class="caption_indo">Mohon lengkapi kuesioner di bawah ini.</div>
	</div>
	...
	<div class="panel-body" style="line-height:150%; text-align:justify;">
		...
		<div id="chapter_<?php echo $c;?>">
			...
			?>
				<tr>
					...
					<td width="50%">
						<?php echo clean_view($dataquestion[$q]["question_desc"]);?>
						<div class="form-group caption_indo80" style="padding-left:15px;"><?php echo clean_view($dataquestion[$q]["question_deskripsi"]);?></div>
					</td>
					<td width="45%">
					<?php					
		...
		?>
			<input type="hidden" name="mod" value="update_candidateQuestion"/>
