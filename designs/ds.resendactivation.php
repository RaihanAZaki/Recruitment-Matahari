...
<div class="top10 bottom10 left10 right10">
	...
	<div class="col-md-12">
		<form name="resendact" id="resendact" method="post" action="<?php echo _PATHURL;?>/letsprocess.php" class="form-horizontal" role="form">
			...
			<div class="col-sm-12">
				<div id="recaptcha_widget" style="display:none">
					...
					<div class="recaptcha_only_if_incorrect_sol" style="color:red">
						...
						<div class="caption_indo">Kode pengaman (captcha) salah.</div>
					</div>
		...
		<div class="form-group bottom10">
			<div class="col-md-6">
				<div class="input-group">
				  <input type="hidden" name="mod" value="register_resendAct">
				  <button type="submit" class="btn btn-success btn-md"><i class="fa fa-paper-plane fa-fw"></i> Resend Activation Code <i>(Kirim Ulang Kode Aktifasi)</i></button>
				</div>
			</div>
		</div>
