...
<div class="panel panel-info" style="margin-bottom:30px;">
	...
	<div class="panel-body" style="line-height:150%; text-align:justify;">		
		...
		<form class="form-horizontal" name="registerform" id="registerform" method="post" action="<?php echo _PATHURL;?>/letsprocess.php" role="form" accept-charset="utf-8">
			...
			<div class="form-group">
				<div class="col-md-3">
					<div class="right bold">Place of birth &nbsp;<span class="asterisk">*</span></div>
					<div class="right caption_indo80 novpadding" style="padding-right:15px;">Tempat lahir sesuai KTP</div>
				</div>
				<div class="col-md-4">
			...
			<div class="form-group">
				<div class="col-md-3">
					<div class="right bold">Date of birth &nbsp;<span class="asterisk">*</span></div>
					<div class="right caption_indo80 novpadding" style="padding-right:15px;">Tanggal lahir sesuai KTP</div>
				</div>
				<div class="col-md-4">
			...
			<div class="form-group">
				<div class="col-md-3">
					<div class="right bold">Gender &nbsp;<span class="asterisk">*</span></div>
					<div class="right caption_indo80 novpadding" style="padding-right:15px;">Jenis kelamin</div>
				</div>
				<div class="col-md-4">
					<label class="radio-inline"><input type="radio" name="sex" id="male" value="male" class="validate[required]"  <?php echo (isset($_SESSION["session"]["sex"]) && $_SESSION["session"]["sex"]=="male")?"checked":"";?> >Male <i>(Pria)</i></label>
					<label class="radio-inline"><input type="radio" name="sex" id="female" value="female" class="validate[required]" <?php echo (isset($_SESSION["session"]["sex"]) && $_SESSION["session"]["sex"]=="female")?"checked":"";?>>Female <i>(Wanita)</i></label>
				</div>
			</div>
			...
			<div class="form-group">
				<div class="col-md-3">
					<div class="right bold">Nationality &nbsp;<span class="asterisk">*</span></div>
					<div class="right caption_indo80 novpadding" style="padding-right:15px;">Warga negara</div>
				</div>
				<div class="col-md-4">
					<label class="radio-inline"><input type="radio" name="nationality" id="wni" value="wni" class="validate[required]" <?php echo (isset($_SESSION["session"]["nationality"]) && $_SESSION["session"]["nationality"]=="wni")?"checked":"";?>>Indonesian <i>(WNI)</i></label>
					<!--saat ini hanya untuk WNI <label class="radio-inline"><input type="radio" name="nationality" id="wna" value="wna" class="validate[required]" <?php echo (isset($_SESSION["session"]["nationality"]) && $_SESSION["session"]["nationality"]=="wna")?"checked":"";?>>Expatriat <i>(WNA)</i></label> -->
				</div>
			</div>
			...
			<div id="partwni" class="form-group" style="<?php echo (isset($_SESSION["session"]["nationality"]) && $_SESSION["session"]["nationality"]=="wni")?"":"display:none";?>">
				<div class="col-md-3">
					<div class="right bold">ID Number (KTP) &nbsp;<span class="asterisk">*</span></div>
					<div class="right caption_indo80 novpadding" style="padding-right:15px;">Nomor KTP</div>
				</div>
				<div class="col-md-4">
					<input type="text" class="form-control" name="nomor_ktp" id="nomor_ktp" title="masukkan nomor KTP Anda yang masih berlaku" placeholder="Please enter your valid ID Number" value="<?php echo (isset($_SESSION["session"]["nomor_ktp"]) && $_SESSION["session"]["nomor_ktp"]<>"")?$_SESSION["session"]["nomor_ktp"]:"";?>">
				</div>
			</div>
			...
			<div id="partwna" class="form-group" style="<?php echo (isset($_SESSION["session"]["nationality"]) && $_SESSION["session"]["nationality"]=="wna")?"":"display:none";?>">
				<div class="col-md-3">
					<div class="right bold">Country &nbsp;<span class="asterisk">*</span></div>
					<div class="right caption_indo80 novpadding" style="padding-right:15px;">Negara</div>
				</div>
				<div class="col-md-4">
					<input type="text" class="form-control" name="country" id="country" title="Negara asal" placeholder="Country of origin" value="<?php echo (isset($_SESSION["session"]["country"]))?$_SESSION["session"]["country"]:"";?>">
				</div>
			
				<div class="col-md-2">
					<div class="right bold">Passport number &nbsp;<span class="asterisk">*</span></div>
					<div class="right caption_indo80 novpadding" style="padding-right:15px;">Nomor passport</div>
				</div>
				<div class="col-md-3">
					<input type="text" class="form-control" name="nomor_passport" id="nomor_passport" title="Masukkan nomor passport Anda yang masih berlaku" placeholder="Please enter your valid Passport Number" value="<?php echo (isset($_SESSION["session"]["nomor_passport"]))?$_SESSION["session"]["nomor_passport"]:"";?>">
				</div>
			</div>
			<!-- akhir part WNA -->
			...
			<div class="form-group">
				<div class="col-md-3">
					<div class="right bold">Cellular number 2 &nbsp;&nbsp;&nbsp;</div>
					<div class="right caption_indo80 novpadding" style="padding-right:15px;">Nomor telepon genggam 2</div>
				</div>
				<div class="col-md-4">
					<input type="text" class="form-control validate[custom[phone]]" name="cellphone2" id="cellphone2" title="Masukkan nomor telepon genggam cadangan Anda" placeholder="Enter your secondary cellular number" value="<?php echo (isset($_SESSION["session"]["cellphone2"]))?$_SESSION["session"]["cellphone2"]:"";?>">
				</div>
			</div>

			<div class="form-group">
				<div class="col-md-3">
					<div class="right bold">Home phone number &nbsp;&nbsp;&nbsp;</div>
					<div class="right caption_indo80 novpadding" style="padding-right:15px;">Nomor telepon rumah</div>
				</div>
				<div class="col-md-4">
					<input type="text" class="form-control validate[custom[phone]]" title="Masukkan nomor telepon rumah Anda" name="homephone" id="homephone" placeholder="Enter your home phone number" value="<?php echo (isset($_SESSION["session"]["homephone"]))?$_SESSION["session"]["homephone"]:"";?>">
				</div>
			</div>
